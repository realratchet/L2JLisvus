...
class Quest (JQuest) :
 ...
 def onKill (self,npc,player,isPet) :
   ...
   if npcId == BARAHAM :
     ...
     partyMember = self.getRandomPartyMember(player, npc, "3")
     if partyMember :
     ...
     partyMember = self.getRandomPartyMember(player, npc, "6")
     if partyMember :
         st = partyMember.getQuestState(qn)
     ...
     partyMember = self.getRandomPartyMember(player, npc, "14")
     if partyMember :
         st = partyMember.getQuestState(qn)
         chance = st.getRandom(100)
