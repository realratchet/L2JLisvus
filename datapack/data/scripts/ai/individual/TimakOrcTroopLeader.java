...
public class TimakOrcTroopLeader extends Quest
{
	...
	{
		super(-1, "timakorctroopleader", "ai/individual");
		registerNPC(TIMAK_ORC_TROOP_LEADER);
	}
	...
	{   
    	...
    	{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 1, npc.getNpcId(), "Destroy the enemy, my brothers!"));
