 ...
 * server is down d: 2nd bit: clock 3rd bit: wont display server name 4th bit: test server (used by client?) c: 0 if you don't want to display brackets in front of sever name ] Server will be considered as Good when the number of online players is less than half the maximum. as Normal between half
