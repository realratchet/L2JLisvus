 ...
 * </p>
 * <p>
 * A SessionKey is made up of two 8 bytes keys. One is send in the {@link net.sf.l2j.loginserver.serverpackets.LoginOk LoginOk} packet and the other is sent in {@link net.sf.l2j.loginserver.serverpackets.PlayOk PlayOk}
 * </p>
 * @author -Wooden-
 */
public class SessionKey
{
	...
	{
		// When server does not show licence, it does not send the LoginOk packet, client does not have this part of the key then.
