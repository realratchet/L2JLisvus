...
public class CharKnownList extends ObjectKnownList
{
    ...
    public final void forgetObjects(boolean fullCheck)
    {
    	if (!fullCheck)
    	{
            ...
            Collection<L2Summon> summons = getKnownSummons().values();
	...
	public Collection<L2Character> getKnownCharactersInRadius(int radius)
	{
		List<L2Character> result = new LinkedList<>();
    ...
    {
        if (_knownSummons == null) _knownSummons = new ConcurrentHashMap<>();
