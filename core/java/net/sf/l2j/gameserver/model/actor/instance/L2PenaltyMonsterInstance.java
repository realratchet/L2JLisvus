...
public class L2PenaltyMonsterInstance extends L2MonsterInstance
{
	...
	public void setPlayerToKill(L2PcInstance ptk)
	{
		...
		{
			NpcSay cs = new NpcSay(getObjectId(), Say2.ALL, getNpcId(), "mmm your bait was delicious.");
			broadcastPacket(cs);
		}
		_ptk = ptk;
	...
	public boolean doDie(L2Character killer)
	{
		...
		{
			NpcSay cs = new NpcSay(getObjectId(), Say2.ALL, getNpcId(), "I will tell fishes not to take your bait!");
			broadcastPacket(cs);
		}
		return true;
	}
