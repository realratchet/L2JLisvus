...
public class State
{
	...
	/**
	 * Discovers the string representation of the state, for readable DB storage.
	 * 
	 * @param state
	 * @return
	 */
	...
	/**
	 * Discovers the state from its string representation (for reconstruction after DB read).
	 * 
	 * @param statename
	 * @return
	 */
