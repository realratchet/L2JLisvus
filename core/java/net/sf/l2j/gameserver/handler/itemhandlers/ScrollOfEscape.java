...
{
    // All the item ids registered to this handler
    private static int[] _itemIds =
    {
        736, 1829, 1830, 1538, 3958, 5858, 5859,
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
    {
        ...
        activeChar.sendPacket(new SetupGauge(SetupGauge.BLUE, skill.getHitTime()));
    ...
    class EscapeFinalizer implements Runnable
    {
		...
		public void run()
        {
            if (_activeChar == null || _activeChar.isDead())
                return;
