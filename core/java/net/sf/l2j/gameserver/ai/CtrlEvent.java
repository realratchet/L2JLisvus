...
/** 
 * This is an enum which contains possible events that can happen on an AI character.
 */
...
public enum CtrlEvent
{
	...
	EVT_FINISH_CASTING,
	/** Actor is immobilized (cannot move) */
	EVT_IMMOBILIZED,
	/** Actor is no longer immobilized */
	EVT_FINISH_IMMOBILIZED
}