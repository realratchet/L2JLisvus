...
public abstract class Condition implements ConditionListener
{
	...
	protected final ConditionListener getListener()
	{
		return _listener;
	}
	
	public final boolean test(Env env, Object owner)
	{
		boolean res = testImpl(env, owner);
	...
	abstract boolean testImpl(Env env, Object owner);
