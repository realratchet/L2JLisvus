...
{
	private static final Logger _log = Logger.getLogger(DateRange.class.getName());
    ...
    public static DateRange parse(String dateRange, DateFormat format)
    {
        ...
        if (date.length == 2)
        {
            ...
            {
            	_log.warning(DateRange.class.getSimpleName() + ": Invalid Date Format." + e);
            }
        }
    ...
    public void setMessages(String[] val)
    {
    	_messages = val;
    }
}